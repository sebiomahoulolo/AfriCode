...
@section('content')
    <div class="final-exam-notice">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h5 class="mb-1">Examen final certifiant</h5>
                <p class="mb-0">Cet examen final permettra aux apprenants d'obtenir leur certificat de réussite s'ils valident tous les modules du cours et obtiennent la note minimale requise.</p>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form class="quiz-form" method="POST" action="{{ route('formateur.final-exam.store', ['courseId' => $course->id]) }}">
                @csrf
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">Créer l'examen final</button>
                </div>
            </form>
        </div>
    </div>
