...
@section('title', 'Certification obtenue | AfriCode')
@section('page-title', 'Votre certificat')

@push('styles')
{{-- Import de la police élégante pour les titres --}}
...
<style>
    ...
    .content {
        text-align: center;
        margin-bottom: 15px;
        padding: 0 1rem; /* Empêche le texte de toucher les bords */
    }
    ...
    .student-name {
        ...
        padding-bottom: 5px; /* Ajusté pour que la ligne soit à la taille du texte */
    }
    ...
    .signatures {
        display: flex;
        justify-content: center;
        gap: 50px; /* Espacement réduit pour éviter le débordement */
        margin-top: auto;
        padding: 0 20px;
    }
    ...
    .signature {
        text-align: center;
        max-width: 220px; /* Largeur maximale pour éviter le débordement */
    }
    ...
    .stamp {
        ...
        width: 100px;
        height: 100px;
        border: 4px double var(--primary-color); /* Bordure plus marquée */
        border-radius: 50%;
        display: flex;
        justify-content: center;
        align-items: center;
        ...
        padding: 8px; /* Léger ajustement du padding */
        background-color: rgba(255,255,255,0.8);
    }

    /* Cercle intérieur pour un effet de cachet plus réaliste */
    .stamp::after {
        content: '';
        position: absolute;
        top: 6px;
...
<div class="container-fluid">
    <div class="row mb-3 print-btn-container">
        <div class="col text-end">
            ...
            <a href="{{ route('apprenant.certifications') }}" class="btn btn-sm btn-secondary ms-2">
    ...
    <div class="certificate-wrapper">
        <div class="certificate-container" id="certificate-box">
            ...
            <div class="certificate">
                <div class="certificate-number">Série: AF-{{ now()->format('Y') }}-{{ str_pad($certification->id, 4, '0', STR_PAD_LEFT) }}</div>
                ...
                <!-- <div class="signatures">
                    <div class="signature">
                        ...
                        <p class="signature-name">Le Formateur</p>
                        <p class="signature-title">Expert Technique Principal</p>
                    </div>

                    <div class="signature">
                        <div class="signature-line"></div>
                        <p class="signature-name">Mahoulolo SEBIO</p>
                        <p class="signature-title">Fondateur & Directeur Général</p>
                    </div>
                </div> -->
                ...
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=75x75&data={{ urlencode(route('verification.form', ['verification_code' => $certification->verification_code])) }}"
...
<script>
    document.getElementById('downloadPDF').addEventListener('click', function() {
        ...
        // Utiliser une classe pour forcer la taille réelle pour le PDF
        element.classList.add('pdf-export');

        html2pdf().set(opt).from(element).save().then(function () {
            // Retirer la classe après la génération
